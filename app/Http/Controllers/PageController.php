...
class PageController extends Controller
{
    public function dashboard(Request $request)
    {
        ...
        $data['count']['failed']    =  $pelatihan->where('status_id', 7)->count();
        $data['count']['success']   =  $pelatihan->where('status_id', 6)->count();
        ...
        for ($i = 1; $i < 13; $i++) {
            ...
            $data['pelatihan']['failed'][]    =  $pelatihan->where('status_id', 7)->count();
            $data['pelatihan']['success'][]   =  $pelatihan->where('status_id', 6)->count();
        }
