<template>
        ...
        <div class="flex flex-col min-h-full">
            ...
            >
                ...
                >
                    ...
                    >
                    <span
                        class="ml-auto h-4 w-4 bg-red-500 rounded-full text-xs my-auto text-center text-white animate-pulse"
                        v-if="
                            menu.route == 'pelatihan.index' &&
                            $page.props.task.length > 0
                        "
                        >{{ $page.props.task.length }}</span
                    >
                </SideLink>
                <a
                    v-if="menu.childs.length > 0"
    ...
    >
        ...
        <slot></slot>
        <div class="mt-auto text-center text-gray-500 pt-4">
