<template>
  ...
  >
    <button
      ...
      class="
        ...
        mx-3
        hover:text-gray-100
        focus:text-gray-100 focus:outline-none focus:bg-gray-700
        transition
        sm:hidden
      "
    >
          ...
          <span v-else class="inline-flex rounded-md">
            <button
              ...
              class="
                ...
                rounded-md
                hover:text-gray-100
                focus:text-gray-1000 focus:outline-none
                transition
              "
            >
      ...
      >
        ...
        >
          ...
          <span
            class="
              ...
              animate-pulse
            "
            v-if="menu.route == 'pelatihan.index' && $page.props.task > 0"
            >{{ $page.props.task }}</span
          >
        </SideLink>
        <a
          v-if="menu.childs.length > 0"
        ...
        >
          <Link
            ...
            :class="{
              'justify-center ': !showSideBar,
              'text-sky-400': resource == menu2.route.split('.')[0],
            }"
  ...
  >
    ...
    <div class="mt-auto text-center text-gray-500">
      © {{ new Date().getFullYear() + " " + $page.props.app.name }}. All rights
      reserved.
    </div>
  </main>
</template>
