<template>
    <AppLayout>
        ...
        <Link
            ...
            v-if="$page.props.task.length > 0"
            class="p-3 mb-3 rounded-lg text-white bg-rose-500 shadow flex items-center"
        >
            <InformationCircleIcon class="h-5 w-5 mr-2" />
            Anda memiliki {{ $page.props.task.length }} tugas yang belum
            diselesaikan.
        </Link>
        <div
            class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-5 gap-3 pb-4 pt-1"
        >
            <div
                class="bg-sky-500 shadow rounded-lg p-6 text-white font-semibold col-span-1 flex flex-col justify-between"
            >
            ...
            <div
                class="bg-yellow-500 shadow rounded-lg p-6 text-white font-semibold col-span-1 flex flex-col justify-between"
            >
            ...
            <div
                class="bg-teal-500 shadow rounded-lg p-6 text-white font-semibold col-span-1 flex flex-col justify-between"
            >
            ...
            <div
                class="bg-violet-500 shadow rounded-lg p-6 text-white font-semibold col-span-1 flex flex-col justify-between"
            >
            ...
            <div
                class="bg-rose-500 shadow rounded-lg p-6 text-white font-semibold col-span-1 sm:col-span-2 xl:col-span-1 flex flex-col justify-between"
            >
