                    ...
                    <div class="p-6 space-y-3">
                        ...
                        >
                            ...
                            <div>
                                ...
                                <input
                                    :min="form.mulai_pendaftaran"
                                    :max="sumDay(form.mulai_pelatihan, -1)"
                                    type="date"
                        ...
                        >
                            <div>
                                ...
                                <input
                                    type="date"
                                    :min="sumDay(form.selesai_pendaftaran, 1)"
                                    :max="form.selesai_pelatihan"
...
export default defineComponent({
    ...
    methods: {
        ...
        sumDay(date_str, countDay) {
            let result = date_str;
            if (date_str) {
                let time = new Date(date_str).getTime() + countDay * 86400000;
