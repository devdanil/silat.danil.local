<template>
  <AppLayout>
        ...
        <div class="flex flex-col sm:flex-row">
          ...
          >
            ...
            <button
              ...
              type="button"
              @click.prevent="batasKonfirmasi('perpanjangan konfirmasi')"
              class="btn btn-md btn-yellow ml-1"
            >
      ...
      <div class="bg-white shadow rounded-lg border-t-2 border-sky-500">
        ...
        <div class="overflow-auto pb-3">
          <table class="min-w-full">
            ...
            <tr class="bg-gray-50" v-if="pelatihan.surat_pemanggilan">
              <td class="pl-6 pr-3 align-top py-2 whitespace-nowrap">
                Surat Pemanggilan
              </td>
              <td class="td">:</td>
              <td class="pl-3 pr-6 py-2 align-top flex items-center">
                <PaperClipIcon class="h-5 w-5 mr-1 text-gray-400" />
                <a
                  target="_blank"
    ...
    <form
      ...
      method="post"
      v-if="pelatihan.status_id == 4 && hasRolesID([pelatihan.status.role_id])"
    >
        ...
        <div class="bg-white px-4 pt-5 pb-4 sm:px-6 sm:py-4">
          <div>
            <label class="block text-sm font-medium text-gray-700 mb-1">
              Batas Waktu Konfirmasi<i class="text-red-500 tex-xs">* </i>
            </label>
          ...
          <div class="mt-3">
            <label class="block text-sm font-medium text-gray-700 mb-1">
              Upload Surat Pemanggilan<i class="text-red-500 tex-xs">* </i>
      ...
      Swal.fire({
        ...
        preConfirm: function () {
          ...
          if (!batas) {
            ...
            return Swal.showValidationMessage("Batas konfirmasi sudah berlalu");
          } else if (
