        ...
        <div class="bg-white shadow rounded-lg border-t-2 border-sky-500">
          <div class="p-6 space-y-3">
            ...
            <div>
              <label class="block text-sm font-medium text-gray-700 mb-1">
                Gambar Ilustrasi
                <i v-if="!katalog.img" class="text-red-500 tex-xs">* </i>
            ...
            <div>
              ...
              >
                ...
                >
                  ...
                  >
                    <div class="w-0 px-2 py-1.5 flex-1 flex items-center">
                      <PaperClipIcon class="h-5 w-5 mr-2 text-gray-400" />
                      <a
                        target="_blank"
                        :href="file.file"
                        class="
                    ...
                    <button
                      type="button"
                      @click.prevent="deleteBahan(file.id)"
                      class="
                        px-2
                        py-1.5
                        flex-shrink-0
      ...
      if (!this.form.deskripsi) {
        ...
        Swal.fire({
          ...
          if (result.isConfirmed) {
            this.form.post(this.route("katalog.update", this.katalog.slug));
          }
        });
      }
    },
        ...
        if (result.isConfirmed) {
          axios({
            ...
            .then((response) => {
              ...
              if (response.data.length == 0 && this.counters.length == 0) {
                this.counters = [0];
              }
            })
            .catch((response) => {
